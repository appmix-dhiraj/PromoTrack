...
<div class="formcontainerL">
	...
	<table width="80%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td valign="top" class="login_box_top">
			</td>
		</tr>
		<tr><td valign="top" class="login_box_middle">	
				...
				<tr>
					<td height="45" colspan="2"><span class="punch_login">Promotool Login</span></td>
					</tr>
...
<tr>
					...
					<td width="66%" height="45"><input name="name" type="text" id="billAddress" size="40" maxlength="50" />  </td>
				</tr>
				<tr>
