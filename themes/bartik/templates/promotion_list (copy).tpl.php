...
<div id="imagemackone"><span class="punchline"><?php echo render($form['label']); ?></span></div>
			...
			<div id="imagemack">
			<div id="leteringsearch"><a href="?q=searchbox" title="Search For A Promotion" alt="Search For A Promotion" rel="lightmodal[search|width:600px;height:500px;]"><img src="<?php echo path_to_theme()?>/images/button_search.png" width="195" height="37"border="0" /></a> </div></div>
				<?php endif;?>
			<?php if($label=='SEARCH RESULTS'):?>
			Other Options: <a href="?q=savesearch" rel="lightmodal[search|width:400px;height:300px;]">Save Search</a> | <a href="?q=searchbox" title="Search For A Promotion" alt="Search For A Promotion" rel="lightmodal[search|width:600px;height:500px;]">Revise Search</a>
			<?php endif;?>
